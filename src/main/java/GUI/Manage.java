 ...
 * @author nguye
 */
public class Manage extends JFrame implements MouseListener{
    ...
    public void init() throws Exception
    {
        ...
        setTitle("Đường đi ngắn nhất và Lập lịch CPU");
...
/************ PHẦN NAVIGATION ( MENU ) **************************/  
        ...
        navItem = new ArrayList<>();  //Chứa thông tin có button cho menu gồm ( Tên btn : icon : icon hover )
            navItem.add("Đường đi ngắn nhất:manage-course.png:manage-course.png");
            navItem.add("Lập lịch CPU:KhachHang_20px.png:KhachHang_20px_active.png");
     ...
     public void changeMainInfo(int i) throws Exception //Đổi Phần hiển thị khi bấm btn trên menu
    {
     /*if(flag && i>4 && i<9) // Thay đổi nếu Thông kế đang dropdown
        ...
        switch(i)
        {
            case 0: // Course
                main.removeAll();
                main.add(new DuongDiNganNhat());
                main.repaint();
                main.revalidate();
            break;
            case 1: // Course
                main.removeAll();
                main.add(new LapLichCPU());
                main.repaint();
                main.revalidate();
            break;
